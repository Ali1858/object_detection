...
def tfms_from_model(sz, aug_tfms=None, max_zoom=None, pad=0, crop_type=CropType.RANDOM,
                    tfm_y=None, sz_y=None, pad_mode=cv2.BORDER_REFLECT, norm_y=True, scale=None):
    ...
    """
    stats = imagenet_stats#inception_stats if f_model in inception_models else imagenet_stats
